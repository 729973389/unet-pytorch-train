...
if __name__ == "__main__":
    ...
    name_classes     =['_background_','tail','fish_body','fin']
    #----------------------------------------------------------------------------------------------------------#
    #   video_path          用于指定视频的路径，当video_path=0时表示检测摄像头
    #                       想要检测视频，则设置如video_path = "xxx.mp4"即可，代表读取出根目录下的xxx.mp4文件。
    #   video_save_path     表示视频保存的路径，当video_save_path=""时表示不保存
    #                       想要保存视频，则设置如video_save_path = "yyy.mp4"即可，代表保存为根目录下的yyy.mp4文件。
    #                       ---保存视频一定要1：1保存原尺寸文件，不然将会导致视频打不开的问题---
    #   video_fps           用于保存的视频的fps
    #
    #   video_path、video_save_path和video_fps仅在m ode='video'时有效
    #   保存视频时需要ctrl+c退出或者运行到最后一帧才会完成完整的保存步骤。
    #----------------------------------------------------------------------------------------------------------#
    # video_path      = 0
    video_path='img/202208201813.mp4'
    video_save_path = ""
    video_fps       = 25.0
    #----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        3、如果想要原图和分割图不混合，可以把detect_image中的mix_type修改。
        ...
        while True:
            ...
            try:
                ...
                # r_image.save("img/img{0}.jpg".format(i))
                r_image.show()
                i=i+1
    elif mode == "video":
